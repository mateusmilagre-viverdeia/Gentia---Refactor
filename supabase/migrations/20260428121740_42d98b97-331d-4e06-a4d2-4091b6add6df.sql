...
DROP TRIGGER IF EXISTS recruitment_jobs_regen_indeed_feed ON public.recruitment_jobs;
CREATE TRIGGER recruitment_jobs_regen_indeed_feed
AFTER INSERT OR UPDATE ON public.recruitment_jobs
FOR EACH ROW
EXECUTE FUNCTION public.trigger_regenerate_indeed_feed();
