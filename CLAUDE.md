...
- ✅ Front de PII fechado: marketplace (`07d1ff8`), careers (`a69ff69`) e **portal** (`b78a0a3` — 100% via `portal-data`, 0 acesso direto). ⏳ Resta (não-crítico, cutover): chrome-extension → destino; endurecer INSERT público `WITH CHECK(true)`; revisar 140 funções definer executáveis por anon.
