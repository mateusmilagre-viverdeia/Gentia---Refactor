...
import { Plus, Trash2, Save, History, Sparkles, Loader2 } from 'lucide-react';
import type { TeamMaturityAssessment } from '@/types/team-maturity.types';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
interface MaturityAssessmentSelectorProps {
  assessments: TeamMaturityAssessment[];
  selectedAssessment: TeamMaturityAssessment | null;
  onSelect: (assessment: TeamMaturityAssessment) => void;
  onCreate: (name: string, description?: string) => Promise<TeamMaturityAssessment | null>;
  onDelete: (id: string) => void;
  onSaveVersion: () => void;
  onOpenHistory: () => void;
  onAnalyzeTeam?: () => void;
  isAnalyzingTeam?: boolean;
  hasPoints?: boolean;
}

export function MaturityAssessmentSelector({
  assessments,
  selectedAssessment,
  onSelect,
  onCreate,
  ...
  isAnalyzingTeam,
  hasPoints,
}: MaturityAssessmentSelectorProps) {
      ...
      {selectedAssessment && (
        <>
          <Button 
            variant="default" 
            size="sm" 
            onClick={onAnalyzeTeam}
            disabled={isAnalyzingTeam || !hasPoints}
          >
            {isAnalyzingTeam ? (
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Ex: Maturidade Q4 2024"
              />
            </div>
            <div className="space-y-2">
