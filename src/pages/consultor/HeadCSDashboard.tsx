...
export default function HeadCSDashboard() {
  ...
  if (roleLoading || loading) {
    return (
      <AppLayout 
        title="Dashboard Head CS"
        breadcrumb={[
          { label: "Home", href: "/" },
          { label: "Consultoria EP", href: "/consultor/dashboard" },
          { label: "Dashboard Head CS" }
        ]}
      >
  ...
  if (error) {
    return (
      <AppLayout title="Dashboard Head CS" breadcrumb={breadcrumb}>
        <div className="p-6">
  ...
  return (
    <AppLayout title="Dashboard Head CS" breadcrumb={breadcrumb}>
      <div className="p-6 space-y-6">
        <div>
          <h1 className="text-2xl font-semibold">Dashboard Head CS</h1>
          <p className="text-muted-foreground">
            Visão geral de todos os projetos de consultoria
          </p>
        </div>
          ...
          <TabsContent value="projetos" className="space-y-6">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button onClick={() => navigate("/admin/consultores")}>
